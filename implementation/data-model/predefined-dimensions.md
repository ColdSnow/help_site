...
| 公众号直接给文字/图片链接，用户打开 | 指广告的具体内容 | 微信-其他 | 如果不使用GrowingIO生成具体的追踪链接，仅可以识别微信环境打开；如果想要识别具体的二维码的信息，例如那篇文章的，哪个公众号等，详情可以了解[广告监测链接](https://docs.growingio.com/ad-tracking/web-marketing/#推广网站)的相关功能。 |
